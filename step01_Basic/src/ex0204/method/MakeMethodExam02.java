...
/*	
	...
	(구현부에서)하는일 : 인수로 받은(들어온) 두개의 정수의 합을 출력하고
		...
		두정수의 합 리턴
*/
	private int methodExam02_01(int i, int k) {
		int sum = i + k;
		if( sum%3 == 0 ) {
			System.out.println("두 정수의 합은 3의 배수입니다."); //출력
		}else {
			System.out.println("두 정수의 합은 3의 배수가 아닙니다.");
		}
		return sum; //55
	}
...
*/
	...
	public String methodExam02_02(String name) {
		String re02 = name + " 바보";
		System.out.println(re02); //장희정 바보
		return re02; //장희정 바보
	}
...
*/
	void methodExam02_03(int i, String k) {
		String re03 = i+k;
		System.out.println(re03); //42이뿌니~
	}
...
/*	
	...
	(구현부에서)하는일 : 첫번째 인수 곱하기 두번째인수 빼기 세번째인수 결과 출력
			     위의 결과를 리턴
*/
	protected static double methodExam02_04(int i, double k, int p) {
		Double re04 = (i * k) - p;
		System.out.println(re04); //30.5
