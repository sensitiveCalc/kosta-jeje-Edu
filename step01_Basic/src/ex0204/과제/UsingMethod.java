...
class UsingMethodExam{
	...
	*/
	public String methodExam03_02(String i, int k) {
		...
		String re03_02 = i + " 바보";
		System.out.println(re03_02);
		
		System.out.println("this = " + this); //현재 생성된 객체
		
		int j = this.methodExam03_01(k); //두번째 인수 값을 methodExam03_01 호출하며 값 출력
	...
	*/	
	protected double methodExam03_04(int i, double j, int k) {
		...
		MakeMethodExam02 me0204 = new MakeMethodExam02();
		double x = me0204.methodExam02_04(i, j, k);
...
class UsingMethod{
	...
	public static void main(String[] args) {
		...
		UsingMethodExam mme = new UsingMethodExam();
		System.out.println("mme = " + mme);

		//The method methodExam03_01(int) from the type UsingMethodExam is not visible
		//um.methodExam03_01(5); //private는 다른 객체에서 접근 불가
		
		String result = mme.methodExam03_02("자바", 5);
		System.out.println("결과 : " + result);

		mme.methodExam03_03(9, "재미있다");

		double re = mme.methodExam03_04(5, 10.5, 3);
		System.out.println("UsingMethod 최종 결과 = " + re);
	}
}
