...
public class MenuView{
  ...
  */
  public void inputInsert(){
	   ...
	   if(InsertResult.INSERT_OUTINDEX == null)
		  EndView.printMessage("더이상 등록할 수 없습니다.");
	   else if(InsertResult.INSERT_DUPLICATE == null)
	   ...
	   //switch 버전
	   switch(result) {
	   		case INSERT_OUTINDEX : EndView.printMessage("더이상 등록할 수 없습니다.");
	   		case INSERT_DUPLICATE : EndView.printMessage(code+"는 중복이므로 등록할 수 없습니다.");
	   		default : EndView.printMessage(code+" 상품이 등록되었습니다.");
	   }
  }
